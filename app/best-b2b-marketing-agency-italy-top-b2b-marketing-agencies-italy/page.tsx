...
export const metadata: Metadata = {
  title: 'Best B2B Marketing Agency Italy 2025 | Top B2B Marketing Agencies Italy',
  description: 'Discover the best B2B marketing agencies Italy has to offer. Compare top Italian B2B marketing consultancies serving Milan, Rome and European markets.',
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="relative py-24 md:py-32 bg-black overflow-hidden">
        <div className="absolute inset-0 opacity-40"><img src="https://images.unsplash.com/photo-1515542622106-78bda8ba0e5b?w=1920&q=80" alt="Best B2B marketing agencies Italy - Milan cathedral" className="w-full h-full object-cover"/><div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/60 to-black"></div></div>
        <div className="relative max-w-7xl mx-auto px-6">
          <span className="text-white/70 text-base uppercase tracking-wider font-semibold">Italy</span>
          <h1 className="text-7xl md:text-9xl font-black text-white mb-8 leading-[0.95] tracking-tight" style={{fontWeight: 900}}>Best B2B Marketing<br/>Agencies Italy</h1>
          <p className="text-2xl md:text-4xl text-gray-200 mb-16 max-w-5xl leading-relaxed font-medium">Discover the top {totalAgencies} B2B marketing agencies Italy has to offer.</p>
      ...
      <section className="bg-zinc-950 border-t border-white/10 py-24"><div className="max-w-7xl mx-auto px-6"><h2 className="text-5xl md:text-6xl font-black text-white mb-10 leading-tight">B2B Marketing Agencies Italy: Design Excellence Meets Enterprise</h2><div className="space-y-8 text-2xl text-white/90 leading-[1.8] font-normal max-w-6xl"><p>Italy's design heritage and manufacturing excellence create a unique B2B marketing landscape where aesthetics matter as much as performance. Italian agencies excel at blending creative excellence with enterprise marketing strategies for the Southern European market.</p></div></div></section>

      <section className="bg-black py-20">
        <div className="max-w-7xl mx-auto px-6 mb-16"><h2 className="text-5xl md:text-6xl font-black text-white mb-6 leading-tight">B2B Marketing Agencies Serving Italy</h2><p className="text-2xl text-white/80 leading-[1.8]">{totalAgencies} verified agencies.</p></div>
