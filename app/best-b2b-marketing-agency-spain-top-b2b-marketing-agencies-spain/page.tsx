      ...
      <section className="bg-zinc-950 border-t border-white/10 py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-8 text-2xl text-white/90 leading-[1.8] font-normal max-w-6xl">
            <p>
              Spain's growing tech ecosystem in Madrid and Barcelona, combined with cultural bridges to Latin America, makes it a strategic hub for B2B marketing. Spanish agencies understand both European enterprise marketing and emerging LATAM markets.
            </p>
          </div>
        </div>
      </section>
