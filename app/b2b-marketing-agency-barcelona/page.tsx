      ...
      <section className="bg-zinc-950 border-t border-white/10 py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-8 text-2xl text-white/90 leading-[1.8] font-normal max-w-6xl">
            <p>
              Barcelona has emerged as Southern Europe's leading startup ecosystem with a <a href="https://en.wikipedia.org/wiki/Economy_of_Barcelona" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 underline">metropolitan GDP of €107.7 billion</a> and 2,285 active startups driving innovation across fintech, healthtech, and mobility sectors. The city attracted €1.15 billion in venture capital during 2024, establishing itself as Spain's technology capital and a Mediterranean gateway for companies expanding across Southern Europe and Latin America.
            </p>
            <p>
