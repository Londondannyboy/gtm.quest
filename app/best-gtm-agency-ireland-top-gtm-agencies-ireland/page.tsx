      ...
      <section className="bg-zinc-950 border-t border-white/10 py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-8 text-2xl text-white/90 leading-[1.8] font-normal max-w-6xl">
            <p>Ireland serves as a strategic bridge between European and US markets, with Dublin hosting European headquarters for major technology companies. Irish GTM agencies combine English-language operations, EU market access, and deep understanding of transatlantic product launches.</p>
            <p>The agencies listed below have been verified for their Irish market presence and expertise in European and global product launches.</p>
          </div>
        </div>
      </section>
