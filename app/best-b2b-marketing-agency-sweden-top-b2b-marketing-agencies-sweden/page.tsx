...
export const metadata: Metadata = {
  title: 'Best B2B Marketing Agency Sweden 2025 | Top B2B Marketing Agencies Sweden',
  description: 'Discover the best B2B marketing agencies Sweden has to offer. Compare top Swedish B2B marketing consultancies serving Stockholm and Nordic markets.',
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="relative py-24 md:py-32 bg-black overflow-hidden">
        <div className="absolute inset-0 opacity-40"><img src="https://images.unsplash.com/photo-1509356843151-3e7d96241e11?w=1920&q=80" alt="Best B2B marketing agencies Sweden - Stockholm harbor" className="w-full h-full object-cover"/><div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/60 to-black"></div></div>
        <div className="relative max-w-7xl mx-auto px-6">
          <span className="text-white/70 text-base uppercase tracking-wider font-semibold">Sweden</span>
          <h1 className="text-7xl md:text-9xl font-black text-white mb-8 leading-[0.95] tracking-tight" style={{fontWeight: 900}}>Best B2B Marketing<br/>Agencies Sweden</h1>
          <p className="text-2xl md:text-4xl text-gray-200 mb-16 max-w-5xl leading-relaxed font-medium">Discover the top {totalAgencies} B2B marketing agencies Sweden has to offer.</p>
      ...
      <section className="bg-zinc-950 border-t border-white/10 py-24"><div className="max-w-7xl mx-auto px-6"><h2 className="text-5xl md:text-6xl font-black text-white mb-10 leading-tight">B2B Marketing Agencies Sweden: SaaS Capital of Europe</h2><div className="space-y-8 text-2xl text-white/90 leading-[1.8] font-normal max-w-6xl"><p>Sweden's unicorn factory has produced Spotify, Klarna, King, and Minecraft. Swedish B2B marketing agencies understand product-led growth, viral mechanics, and scaling SaaS across Europe with sophisticated digital-first strategies and Nordic design sensibilities.</p></div></div></section>

      <section className="bg-black py-20">
        <div className="max-w-7xl mx-auto px-6 mb-16"><h2 className="text-5xl md:text-6xl font-black text-white mb-6 leading-tight">B2B Marketing Agencies Serving Sweden</h2><p className="text-2xl text-white/80 leading-[1.8]">{totalAgencies} verified agencies.</p></div>
