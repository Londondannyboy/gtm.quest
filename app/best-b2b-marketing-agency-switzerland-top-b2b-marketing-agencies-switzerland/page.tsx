    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="relative py-24 md:py-32 bg-black overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 max-w-4xl">
            ...
            <div>
              <div className="text-6xl font-black text-white mb-3">CHF{Math.round(avgMinBudget / 1000)}K+</div>
      ...
      <section className="bg-zinc-950 border-t border-white/10 py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-8 text-2xl text-white/90 leading-[1.8] font-normal max-w-6xl">
            <p>
              Switzerland's unique position as <a href="https://en.wikipedia.org/wiki/Economy_of_Switzerland" className="text-blue-400 hover:text-blue-300 underline" target="_blank" rel="noopener">one of the world's wealthiest economies</a> at the intersection of banking, pharmaceuticals, precision manufacturing, and international organizations creates one of the world's most sophisticated B2B marketing environments. Swiss agencies understand the critical importance of discretion, compliance, and technical precision in enterprise marketing.
            </p>
            <p>
              With Zurich serving as a global financial hub and Geneva hosting countless international organizations, Swiss B2B marketing agencies excel at multilingual campaigns (German, French, Italian, English), navigating complex regulatory frameworks, and marketing to highly educated, discerning enterprise buyers. According to <a href="https://www.bfs.admin.ch/bfs/en/home.html" className="text-blue-400 hover:text-blue-300 underline" target="_blank" rel="noopener">Swiss Federal Statistical Office data</a>, Switzerland's pharmaceutical sector generates over CHF 100 billion annually, making it Europe's leading pharma hub. The Swiss market demands exceptional quality, meticulous attention to detail, and long-term relationship building over aggressive sales tactics.
            </p>
            <p>
              Swiss B2B agencies particularly excel in pharma and life sciences marketing, financial services communications, precision manufacturing positioning, and international B2B campaigns that require cultural sensitivity across multiple European markets. They leverage <a href="https://www.admin.ch/gov/en/start.html" className="text-blue-400 hover:text-blue-300 underline" target="_blank" rel="noopener">Switzerland's neutral status and political stability</a> to help B2B vendors position offerings for risk-averse enterprise buyers who value substance over flash, proven track records over promises, and partnerships over transactions.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-500 py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl text-white/95 mb-12">Create a B2B marketing strategy for Switzerland and Central European markets.</p>
          <Link
            href="/planner"
