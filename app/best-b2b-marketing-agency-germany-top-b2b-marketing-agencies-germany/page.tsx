...
export const metadata: Metadata = {
  title: 'Best B2B Marketing Agency Germany 2025 | Top B2B Marketing Agencies Germany',
  description: 'Discover the best B2B marketing agencies Germany has to offer. Compare top German B2B marketing consultancies serving Berlin, Munich and European markets.',
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="relative py-24 md:py-32 bg-black overflow-hidden">
        <div className="absolute inset-0 opacity-40"><img src="https://images.unsplash.com/photo-1560969184-10fe8719e047?w=1920&q=80" alt="Best B2B marketing agencies Germany - Berlin Brandenburg Gate" className="w-full h-full object-cover" /><div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/60 to-black"></div></div>
        <div className="relative max-w-7xl mx-auto px-6">
          <span className="text-white/70 text-base uppercase tracking-wider font-semibold">Germany</span>
          <h1 className="text-7xl md:text-9xl font-black text-white mb-8 leading-[0.95] tracking-tight" style={{fontWeight:900}}>Best B2B Marketing<br/>Agencies Germany</h1>
          <p className="text-2xl md:text-4xl text-gray-200 mb-16 max-w-5xl leading-relaxed font-medium">Discover the top {totalAgencies} B2B marketing agencies Germany has to offer—verified experts serving Europe's largest economy.</p>
      ...
      <section className="bg-zinc-950 border-t border-white/10 py-24">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-5xl md:text-6xl font-black text-white mb-10 leading-tight">B2B Marketing Agencies Germany: Europe's Industrial Powerhouse</h2>
          <div className="space-y-8 text-2xl text-white/90 leading-[1.8] font-normal max-w-6xl">
            <p>Germany represents Europe's largest economy and a global leader in industrial manufacturing, automotive, engineering, and enterprise technology. Berlin, Munich, Frankfurt, and Hamburg serve as major B2B hubs. German B2B agencies understand Mittelstand companies, complex industrial sales cycles, and the engineering-driven decision-making culture that defines German business.</p>
            <p>The agencies listed below have been verified for their expertise serving German and European markets with proven capabilities in B2B marketing and demand generation.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-black py-20">
        <div className="max-w-7xl mx-auto px-6 mb-16">
          <h2 className="text-5xl md:text-6xl font-black text-white mb-6 leading-tight">B2B Marketing Agencies Serving Germany</h2>
