...
export const metadata: Metadata = {
  title: 'Fractional CMO Jobs UK 2025 - Part-Time Marketing Leadership Roles',
  description: 'Find fractional CMO jobs in the UK. Part-time Chief Marketing Officer positions paying £700-£1,400/day. Browse 40+ live CMO roles for experienced marketing leaders.',
  keywords: 'fractional cmo jobs uk, fractional cmo jobs, part time cmo jobs, fractional cmo uk, cmo jobs uk',
  openGraph: {
    title: 'Fractional CMO Jobs UK 2025 - Part-Time Marketing Leadership',
    description: 'Find fractional CMO jobs in the UK. Part-time CMO positions paying £700-£1,400/day.',
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-purple-900 to-purple-800 py-20">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Find part-time Chief Marketing Officer roles in the UK. Browse {jobCount}+ live fractional CMO jobs paying £700-£1,400 per day.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="grid grid-cols-3 gap-8 text-center">
            <div>
              ...
              <div className="text-gray-600">Live CMO Jobs</div>
            </div>
            <div>
      ...
      <section className="py-8 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <img
            ...
            alt="Fractional CMO jobs UK - marketing executive leading strategy meeting"
      ...
      <article className="py-16">
        <div className="max-w-4xl mx-auto px-4 prose prose-lg prose-purple">
          ...
          <p>
            The UK market for <strong>fractional CMO jobs</strong> has exploded, with a 200% year-on-year increase in searches for "fractional CMO UK". This growth reflects how startups, scale-ups, and SMEs are accessing world-class marketing talent without the £120,000-£200,000 annual cost of a full-time Chief Marketing Officer.
          </p>

          <h2>Why Fractional CMO Jobs Are Booming in the UK</h2>
          <p>Several factors are driving the rapid growth of <strong>fractional CMO jobs UK</strong>:</p>
          <ul>
          ...
          <p>The UK <strong>fractional CMO jobs</strong> market offers diverse opportunities:</p>
          <ul>
          ...
          <p>While London leads the <strong>fractional CMO jobs UK</strong> market with approximately 55% of roles, opportunities exist nationwide:</p>
          <ul>
          ...
          <p>High-demand sectors for <strong>fractional CMO jobs</strong> include:</p>
          <ul>
          ...
          <p>The best channels for finding <strong>fractional CMO jobs in the UK</strong> include:</p>
          <ul>
          ...
          <p>Successful candidates for <strong>fractional CMO jobs UK</strong> typically have:</p>
          <ul>
      ...
      {jobs.length > 0 && (
        <section className="py-16 bg-gray-50">
          <div className="max-w-4xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Latest Fractional CMO Jobs UK</h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/fractional-jobs-london" className="px-4 py-2 bg-white rounded-lg border hover:border-purple-300">CMO Jobs London →</Link>
