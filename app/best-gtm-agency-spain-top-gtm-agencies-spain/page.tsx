      ...
      <section className="bg-zinc-950 border-t border-white/10 py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-8 text-2xl text-white/90 leading-[1.8] font-normal max-w-6xl">
            <p>
              Spain's strategic position bridges European and Latin American markets, with Madrid and Barcelona serving as tech hubs for Southern Europe. Spanish GTM agencies excel at bilingual strategies, understanding both European enterprise sales and LATAM market expansion.
            </p>
          </div>
        </div>
      </section>
