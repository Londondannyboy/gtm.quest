      ...
      <section className="bg-zinc-950 border-t border-white/10 py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-8 text-2xl text-white/90 leading-[1.8] font-normal max-w-6xl">
            <p>
              Amsterdam has established itself as <a href="https://en.wikipedia.org/wiki/Economy_of_Amsterdam" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 underline">Europe's fintech capital</a> with €3.1 billion in venture capital investment during 2024 and over 1,200 active startups. The city hosts Adyen, Booking.com, TomTom, and other technology leaders while serving as the European gateway for international companies entering continental markets through the Netherlands' strategic location and multilingual talent pool.
            </p>
            <p>
