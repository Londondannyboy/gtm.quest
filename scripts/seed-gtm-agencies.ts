  ...
  const agencies = [
    {
      ...
      b2b_description: 'GTM Quest delivers AI-driven B2B marketing strategy for SaaS and technology companies. Trusted by B2B marketers at startups and scale-ups across fintech, martech, and enterprise software sectors, the platform accelerates strategy development from weeks to hours. GTM Quest specializes in helping B2B teams nail positioning, define ICPs, and build multi-channel demand generation frameworks before spending growth budgets. Industries served include B2B SaaS, fintech, cybersecurity, and enterprise technology. The platform democratizes GTM expertise, making strategic planning accessible without $50K+ agency retainers.',
      key_services: ['AI-Powered GTM Strategy', 'B2B Positioning & Messaging', 'ICP Definition', 'Demand Gen Planning', 'Channel Strategy', 'Go-to-Market Roadmaps'],
      logo_url: null,
    ...
    },
    {
      ...
      b2b_description: 'Ziggy is a demand generation agency that helps ambitious B2B tech brands scale revenue through proven growth strategies. They work with brands of all sizes, from startups to Fortune 500s, to drive revenue growth and reduce customer acquisition costs. Trusted by leading companies like Stripe, Planet, Canon, and Bloomreach, Ziggy provides results-driven strategies to achieve business goals. They specialize in helping B2B SaaS, fintech, and enterprise software companies nail positioning before scaling demand generation programs. Ziggy excels at transforming "nice to have" products into "must have" solutions through sharp positioning, messaging clarity, and systematic demand creation.',
      key_services: ['B2B Demand Generation', 'Positioning Strategy', 'Messaging & Differentiation', 'Revenue Growth Programs', 'Customer Acquisition', 'GTM Strategy'],
      logo_url: null,
    ...
    },
    {
      ...
      description: 'Rocket Agency is a full-service digital marketing agency with offices in Sydney and Melbourne, specializing in B2B and SaaS marketing. As a Google Premier Partner (top 3% in Australia), HubSpot Platinum Partner, and Facebook Business Partner, they deliver comprehensive digital strategies including SEO, PPC, paid social, and marketing automation. Founded with a focus on data-driven growth, Rocket has won 30+ industry awards and serves B2B technology companies, SaaS platforms, and enterprise organizations across Australia. Their dual-city presence provides strong coverage of Australia\'s two major tech hubs, combining local market expertise with sophisticated digital marketing capabilities.',
      b2b_description: 'Rocket Agency delivers data-driven B2B marketing and demand generation for Australian SaaS and technology companies. With offices in Sydney and Melbourne, they combine Google Premier Partner status (top 3% in Australia) with HubSpot Platinum certification to execute sophisticated B2B marketing programs. Rocket specializes in driving demos and trials for SaaS companies through integrated campaigns across SEO, PPC, LinkedIn advertising, and marketing automation. Their B2B expertise spans lead generation, conversion optimization, and full-funnel demand generation for Australian technology firms targeting domestic and international markets. As one of Australia\'s most awarded digital agencies (30+ awards), Rocket brings enterprise-grade B2B marketing execution to the Australian market.',
      key_services: ['B2B SEO', 'PPC & Paid Social', 'LinkedIn Advertising', 'HubSpot Marketing Automation', 'SaaS Lead Generation', 'Conversion Rate Optimization', 'Digital Strategy'],
      logo_url: null,
      website: 'https://www.rocketagency.com.au',
      specializations: ['B2B SaaS Marketing', 'Lead Generation', 'Demand Generation', 'Digital Marketing'],
      global_rank: 13,
      employee_count: null,
      founded_year: null,
      service_areas: ['Australia', 'Sydney', 'Melbourne', 'Global'],
      brand_dev_domain: 'rocketagency.com.au',
      pricing_model: 'Monthly Retainer',
      min_budget: 5000,
      category_tags: ['B2B Marketing Agency', 'Digital Marketing Agency', 'Demand Generation Agency'],
    },
    {
      slug: 'hypeanddexter',
      name: 'Hype & Dexter',
      app: 'gtm',
      status: 'published',
      headquarters: 'Auckland, New Zealand (APAC)',
      description: 'Hype & Dexter is APAC\'s leading HubSpot Solutions Partner, serving businesses across Australia, New Zealand, and globally. Part of the Avidly Group, they specialize in enterprise CRM implementation, marketing automation, and digital transformation for B2B organizations. Their consultancy approach focuses on delivering transformational results through HubSpot platform implementation, system integrations, website development, and ongoing optimization. With a client roster spanning manufacturing, real estate, media, healthcare, and financial services, Hype & Dexter brings deep expertise in scaling B2B marketing and sales operations across the APAC region. Their enterprise focus makes them particularly valuable for mid-market and large organizations implementing sophisticated marketing technology stacks.',
      b2b_description: 'Hype & Dexter is APAC\'s premier B2B marketing and revenue operations consultancy, specializing in HubSpot-powered growth for Australian and New Zealand enterprises. As the region\'s top HubSpot Solutions Partner, they architect sophisticated marketing automation, CRM implementations, and RevOps systems for B2B organizations scaling across APAC markets. Their enterprise-grade solutions span marketing automation, sales enablement, and customer success platforms, with particular expertise in complex system integrations and multi-market implementations. Hype & Dexter serves major Australian enterprises including Lendlease, Suzuki, and Brother, delivering HubSpot implementations that unify marketing, sales, and service operations. For B2B companies in Australia and New Zealand, they provide the strategic and technical expertise to build scalable revenue engines.',
      key_services: ['HubSpot Implementation', 'Marketing Automation', 'CRM & RevOps', 'Enterprise Integrations', 'Website Development', 'B2B Consulting'],
      logo_url: null,
      website: 'https://www.hypeanddexter.com',
      specializations: ['HubSpot', 'Marketing Automation', 'Enterprise B2B', 'RevOps'],
      global_rank: 14,
      employee_count: null,
      founded_year: null,
      service_areas: ['Australia', 'New Zealand', 'APAC', 'Global'],
      brand_dev_domain: 'hypeanddexter.com',
      pricing_model: 'Monthly Retainer',
      min_budget: 8000,
      category_tags: ['B2B Marketing Agency', 'GTM Agency', 'Revenue Operations Agency', 'HubSpot Partner'],
    },
  ]
